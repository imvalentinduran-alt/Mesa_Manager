#!/usr/bin/env python3
"""Seed masivo: 25 profesores nuevos, 60 estudiantes nuevos, 30 mesas — UPEL Mesa Manager."""
...
PROFESORES = [
    ...
    ("14400014","Salvador", "Mujica",     "Recreación",                       "s.mujica@upel.edu.ve"),
    ("14500015","Teresa",   "Alvarado",   "Informática Educativa",            "t.alvarado@upel.edu.ve"),
    ("14600016","Guillermo","Bravo",      "Orientación Educativa",            "g.bravo@upel.edu.ve"),
    ("14700017","Esperanza","Chacón",     "Innovación Educativa",             "e.chacon@upel.edu.ve"),
    ("14800018","Jorge",    "Figueroa",   "Gerencia Educacional",             "j.figueroa@upel.edu.ve"),
    ("14900019","Amelia",   "Acosta",     "Planificación Global",             "a.acosta@upel.edu.ve"),
    ("15000020","Néstor",   "Quintero",   "Educación, Ambiente y Desarrollo", "n.quintero@upel.edu.ve"),
    ("15100021","Iris",     "Figuera",    "Enseñanza de la Educación Física", "i.figuera@upel.edu.ve"),
    ("15200022","Bruno",    "Lunar",      "Recreación",                       "b.lunar@upel.edu.ve"),
    ("15300023","Mireya",   "Oropeza",    "Informática Educativa",            "m.oropeza@upel.edu.ve"),
    ("15400024","Freddy",   "Peraza",     "Orientación Educativa",            "f.peraza@upel.edu.ve"),
    ("15500025","Xiomara",  "Tovar",      "Innovación Educativa",             "x.tovar@upel.edu.ve"),
]

# ── 60 nuevos estudiantes ────────────────────────────────────────────────────
...
ESTUDIANTES = [
    ...
    ("22300005","Ramiro",   "Landaeta",   "PG","2021-I", "Planificación y desarrollo local"),
    ("22300006","Pablo",    "Marcano",    "PG","2021-II","Gestión de proyectos educativos"),
    ("22300007","Claudia",  "Navas",      "PG","2024-I", "Planificación integrada en universidades"),
    ("22300008","Salvador", "Oliveros",   "PG","2022-I", "Seguimiento y evaluación de planes educativos"),
    # EAD - 8
    ...
    ("22400005","Amelia",   "Torrealba",  "EAD","2021-I", "Ambiente y valores en la escuela primaria"),
    ("22400006","Néstor",   "Useche",     "EAD","2021-II","Gestión ambiental en instituciones educativas"),
    ("22400007","Iris",     "Villalba",   "EAD","2024-I", "Conciencia ambiental y medios de comunicación"),
    ("22400008","Bruno",    "Zerpa",      "EAD","2022-I", "Currículo y biodiversidad en educación básica"),
    # EEF - 7
    ...
    ("22500005","Andrés",   "Flores",     "EEF","2021-I", "Educación física inclusiva"),
    ("22500006","Silvia",   "Castro",     "EEF","2021-II","Evaluación motriz en educación primaria"),
    ("22500007","Rebeca",   "Reyes",      "EEF","2024-I", "Recreación activa y calidad de vida"),
    # REC - 7
    ...
    ("22600003","Carmen",   "González",   "REC","2023-I", "Recreación terapéutica en contexto hospitalario"),
    ("22600004","Diego",    "Rodríguez",  "REC","2023-II","Turismo social y recreación educativa"),
    ("22600005","Adriana",  "Díaz",       "REC","2021-I", "Recreación en la prevención del sedentarismo"),
    ("22600006","Rafael",   "Torres",     "REC","2021-II","Ludotecas comunitarias como espacio educativo"),
    ("22600007","Sofía",    "Ramírez",    "REC","2024-I", "Recreación y desarrollo de habilidades sociales"),
    # INF - 7
    ...
    ("22700005","Alejandro","Romero",     "INF","2021-I", "Entornos virtuales y formación continua docente"),
    ("22700006","Ingrid",   "Sánchez",    "INF","2021-II","Plataformas LMS y evaluación en línea"),
    ("22700007","Nathaly",  "Mendoza",    "INF","2024-I", "Tecnología móvil en el aprendizaje universitario"),
    # OE - 7
    ...
    ("22800005","Rafael",   "Briceño",    "OE","2021-I", "Proyecto de vida y tutoría universitaria"),
    ("22800006","Eduardo",  "Dugarte",    "OE","2021-II","Orientación y atención a la diversidad"),
    ("22800007","Mariana",  "Espinoza",   "OE","2024-I", "Mediación escolar y resolución de conflictos"),
]
...
MESAS = [
    ...
    # Lunes 2 Jun — DÍA LLENO (3 mesas)
    ("22100001","Aula A-101",       "2026-06-02","08:00","10:00",1,"Aprobada",        "Aprobado"),
    ("22200001","Aula B-202",       "2026-06-02","10:00","12:00",1,"Aprobada",        "Aprobado"),
    ("22300001","Sala Postgrado 1", "2026-06-02","11:00","13:00",2,"Con_Correcciones","Con_Correcciones"),
    # Miércoles 4 Jun
    ("22400001","Aula A-101",       "2026-06-04","08:00","10:00",1,"Aprobada",        "Aprobado"),
    ("22500001","Sala Extension 1", "2026-06-04","10:00","12:00",1,"Con_Correcciones","Con_Correcciones"),
    # Jueves 5 Jun — DÍA LLENO (3 mesas)
    ("22600001","Aula A-101",       "2026-06-05","08:00","10:00",1,"Aprobada",        "Aprobado"),
    ("22700001","Aula B-202",       "2026-06-05","10:00","12:00",2,"Reprobada",       "Reprobado"),
    ("22800001","Aula C-303",       "2026-06-05","11:00","13:00",1,"Suspendida",      None),
    # Viernes 6 Jun
    ("22100002","Sala Postgrado 1", "2026-06-06","09:00","11:00",1,"Aprobada",        "Aprobado"),
    ("22200002","Aula A-101",       "2026-06-06","11:00","13:00",2,"Con_Correcciones","Con_Correcciones"),
    # ═══ FUTURAS — Programada ════════════════════════════════════════════════
    # Lunes 9 Jun
    ("22300002","Aula A-101",       "2026-06-09","08:00","10:00",1,"Programada",None),
    ("22400002","Aula B-202",       "2026-06-09","10:00","12:00",1,"Programada",None),
    # Martes 10 Jun — DÍA MUY LLENO (4 mesas)
    ("22500002","Aula A-101",       "2026-06-10","08:00","10:00",1,"Programada",None),
    ("22600002","Aula B-202",       "2026-06-10","10:00","12:00",1,"Programada",None),
    ("22700002","Sala Postgrado 1", "2026-06-10","11:00","13:00",2,"Programada",None),
    ("22800002","Sala Extension 1", "2026-06-10","11:00","13:00",1,"Programada",None),
    # Lunes 16 Jun
    ("22100003","Aula A-101",       "2026-06-16","09:00","11:00",1,"Programada",None),
    ("22200003","Aula C-303",       "2026-06-16","11:00","13:00",1,"Programada",None),
    # Lunes 23 Jun
    ("22300003","Sala Postgrado 1", "2026-06-23","10:00","12:00",2,"Programada",None),
    ("22400003","Aula B-202",       "2026-06-23","11:00","13:00",1,"Programada",None),
    # Lunes 7 Jul — DÍA MUY LLENO (4 mesas)
    ("22500003","Aula A-101",       "2026-07-07","08:00","10:00",1,"Programada",None),
    ("22600003","Aula B-202",       "2026-07-07","10:00","12:00",1,"Programada",None),
    ("22700003","Sala Postgrado 1", "2026-07-07","11:00","13:00",2,"Programada",None),
    ("22800003","Aula C-303",       "2026-07-07","11:00","13:00",1,"Programada",None),
    # Martes 8 Jul
    ("22100004","Sala Extension 1", "2026-07-08","09:00","11:00",1,"Programada",None),
    ("22200004","Aula A-101",       "2026-07-08","11:00","13:00",2,"Programada",None),
    # Lunes 14 Jul — DÍA LLENO (3 mesas)
    ("22300004","Aula A-101",       "2026-07-14","08:00","10:00",1,"Programada",None),
    ("22400004","Aula B-202",       "2026-07-14","10:00","12:00",1,"Programada",None),
    ("22500004","Sala Postgrado 1", "2026-07-14","11:00","13:00",1,"Programada",None),
    # Lunes 21 Jul
    ("22600004","Aula A-101",       "2026-07-21","10:00","12:00",2,"Programada",None),
]
...
def run():
    ...
    print(f"Estudiantes en DB: {cur.fetchone()[0]}")
    ...
    print(f"Aulas disponibles: {list(aula_map.keys())}")
    ...
    for ced_e, nom_a, fecha, hi, hf, tipo, estado, veredicto in MESAS:
        ...
        if not est_id:
            print(f"  SKIP: estudiante {ced_e} no encontrado")
            continue
        if not aula_id:
            print(f"  SKIP: aula '{nom_a}' no encontrada")
            continue
        cur.execute(
            "SELECT id_tutor_principal,id_tutor_suplente,id_jurado1_principal,"
